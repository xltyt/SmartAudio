...
Frontend::Frontend(const std::string& speech_tokenizer_model_path) {
...
#endif
  Ort::Env env(ORT_LOGGING_LEVEL_WARNING, "speech_tokenizer");
  _speech_tokenizer_session = std::make_unique<Ort::Session>(env, speech_tokenizer_model_path.c_str(), option);
